 ...
 */
class SlackbotHandler extends \AIOSEO\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \AIOSEO\Vendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
