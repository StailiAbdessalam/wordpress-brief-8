 ...
 */
class LineFormatter extends \AIOSEO\Vendor\Monolog\Formatter\NormalizerFormatter
{
    ...
    protected function normalizeException($e)
    {
        ...
        if ($previous = $e->getPrevious()) {
            do {
                $previousText .= ', ' . \AIOSEO\Vendor\Monolog\Utils::getClass($previous) . '(code: ' . $previous->getCode() . '): ' . $previous->getMessage() . ' at ' . $previous->getFile() . ':' . $previous->getLine();
            } while ($previous = $previous->getPrevious());
        }
        $str = '[object] (' . \AIOSEO\Vendor\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode() . '): ' . $e->getMessage() . ' at ' . $e->getFile() . ':' . $e->getLine() . $previousText . ')';
        if ($this->includeStacktraces) {
            $str .= "\n[stacktrace]\n" . $e->getTraceAsString() . "\n";
        }
        return $str;
