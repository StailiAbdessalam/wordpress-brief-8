 ...
 */
class MandrillHandler extends \AIOSEO\Vendor\Monolog\Handler\MailHandler
{
    protected $message;
    protected $apiKey;
    /**
     ...
     */
    public function __construct($apiKey, $message, $level = \AIOSEO\Vendor\Monolog\Logger::ERROR, $bubble = \true)
    {
