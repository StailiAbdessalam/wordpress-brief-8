 ...
 */
abstract class AbstractHandler implements \AIOSEO\Vendor\Monolog\Handler\HandlerInterface, \AIOSEO\Vendor\Monolog\ResettableInterface
{
    protected $level = \AIOSEO\Vendor\Monolog\Logger::DEBUG;
