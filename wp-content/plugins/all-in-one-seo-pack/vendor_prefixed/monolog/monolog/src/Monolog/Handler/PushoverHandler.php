 ...
 */
class PushoverHandler extends \AIOSEO\Vendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \AIOSEO\Vendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \AIOSEO\Vendor\Monolog\Logger::CRITICAL, $emergencyLevel = \AIOSEO\Vendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \AIOSEO\Vendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \AIOSEO\Vendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
